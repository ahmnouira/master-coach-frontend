...
export class ModalWorkingHoursComponent implements OnInit {
    ...
    this.ngxSmartModalService
      ...
      .onOpen.subscribe((modal) => {
        ...
        if (this.coach.working_hours) {
          ...
          this.heureDeb.setHours(
            coachHeureDeb.getHours(),
            coachHeureDeb.getMinutes()
          );
          this.heureFin.setHours(
            coachHeureFin.getHours(),
            coachHeureFin.getMinutes()
          );
  ...
  saveData() {
    ...
    this.coachService
      .addWorkingHours(this.coach._id, param)
      .subscribe((data) => {
        console.log(data);
