...
export class CreateUserComponent implements OnInit {
  ...
  errorMessage = '';
  accountType = 'Coach';
  constructor(public router: Router, private authService : AuthService, private tokenStorage: TokenStorageService, private titleService:Title, private  userService: UserService, private activatedRoute : ActivatedRoute) {
  ...
  createUser() {
    ...
    this.userService.saveUser(this.form).subscribe(res => {
