...
export class ParametresComponent implements OnInit {
  ...
  constructor(private tokenStorageService : TokenStorageService, private userService : UserService, private adminService : AdminService) { }

  ngOnInit(): void {
    const user = this.tokenStorageService.getUser();
    this.getUserFromDb(user._id)
    if(!this.form.photo) {
      this.form.photo = 'assets/img/common/ceo-of-company-in-business-offices-2021-08-26-17-31-26-utc.png';
    }
    this.settings = {
      text: "Sélectionner...",
